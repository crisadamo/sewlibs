...
(********************************* MC_SendEmail_SMTP **************************)
(*ERRORS *)
SMTP_TIMEOUT: UDINT := 16#FE00403;                      (* 403 - Timeout, The module can't comunicate with the server or
                                                         * it doesn't respond *)
...
(************************************ MC_Client_FTP ***************************)
(* ERRORS *)
FTP_TIMEOUT:UDINT := 16#FF003B0;                        (* 3B0 - Timeout, The module can't comunicate with the server or
                                                         * it doesn't respond *)
