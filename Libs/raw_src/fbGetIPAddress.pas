...
(******************************************************************************************************************
	Programmed:	12.03.2008	Cristian Adamo  <cristian.adamo@sew-eurodrive.com.ar>  -  SEW EURODRIVE Argentina S.A.	
	Current Version: 1.0 		
	Change:	Ver		Date			  Author				    Description:
          v1.0	12.03.2009	Cristian Adamo		Generation of Program
*******************************************************************************************************************)
...
IF (Enable) THEN
  bFlagRead := TRUE;
	...
	IF (fbGetIP.DataOut > 0) THEN
		...
		yIPTempOctet1 := DWORD_TO_BYTE(SHR((dwIPTemp AND 2#11111111000000000000000000000000) ,24));
		yIPTempOctet2 := DWORD_TO_BYTE(SHR((dwIPTemp AND 2#111111110000000000000000) ,16));
